...
#define PFERR_PRESENT                                                          \
  0x1                   // Fault happened due to a protection
                        //   violation (rather than due to a
                        //   missing page)
#define PFERR_WRITE 0x2 // Fault happened on a write
#define PFERR_USER                                                             \
  0x4 // Fault happened in an application
...
DECLARE_X86_FUNCTION(void cpuid(uint32_t info, uint32_t *eaxp, uint32_t *ebxp,
