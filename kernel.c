...
x86_64_pagetable *pagetable_alloc(void) { return page_alloc(current->p_pid); }
...
void exception(x86_64_registers *reg) {
  ...
  case INT_SYS_PAGE_ALLOC: {
    ...
    if (r >= 0) {
      virtual_memory_map(current->p_pagetable, addr, addr, PAGESIZE,
...
void check_page_table_mappings(x86_64_pagetable *pt) {
  ...
  for (uintptr_t va = KERNEL_START_ADDR; va < (uintptr_t)end; va += PAGESIZE) {
...
static const uint16_t memstate_colors[] = {
    'K' | 0x0D00, 'R' | 0x0700, '.' | 0x0700, '1' | 0x0C00, '2' | 0x0A00,
    '3' | 0x0900, '4' | 0x0E00, '5' | 0x0F00, '6' | 0x0C00, '7' | 0x0A00,
    '8' | 0x0900, '9' | 0x0E00, 'A' | 0x0F00, 'B' | 0x0C00, 'C' | 0x0A00,
    'D' | 0x0900, 'E' | 0x0E00, 'F' | 0x0F00};
